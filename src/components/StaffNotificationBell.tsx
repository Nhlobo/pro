...
//
// INTERNAL STAFF bell only — admin/employee layout. Deliberately a
// separate component from NotificationCenter.tsx (attorney/expert
// portal bell), using the separate useStaffNotifications.tsx hook —
// see that hook's module comment for why staff and portal sessions
// are kept fully un-shared rather than one bell serving both.
...
export const StaffNotificationBell: React.FC = () => {
  ...
  const handleNotificationClick = (notification: Notification) => {
    ...
    // Staff bell only ever needs the 'admin' portal branch — no
    // pathname-based portal detection needed since this component is
    // only ever mounted inside AdminPortalLayout.
