...
// list_cases action (external-portal-expert-data), the same source
// used by the OTP-authenticated new-module UI. See useExpertPortal.ts.
          ...
          <Card>
            <CardHeader className="flex flex-row items-center justify-between">
              ...
              <Button variant="ghost" size="sm" asChild>
                <Link to="/expert-portal/cases">View all <ArrowRight className="ml-1 h-3.5 w-3.5" /></Link>
              </Button>
            </CardHeader>
            <CardContent className="space-y-2">
              ...
              {cases.slice(0, 5).map(c => (
                <Link
                  ...
                  to={`/expert-portal/case/${c.appointment_id}`}
