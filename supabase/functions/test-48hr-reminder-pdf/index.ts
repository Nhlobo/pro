...
function generatePdfSummary(reminder: AppointmentReminder): Uint8Array {
  ...
  reminder.appointments.forEach((apt, index) => {
    ...
    if (index % 2 === 1) { doc.setFillColor(249, 250, 251); doc.rect(15, yPos - 4, 180, 12, 'F'); }
    doc.setTextColor(0, 0, 0);
...
const handler = async (req: Request): Promise<Response> => {
  ...
  try {
    ...
    const sampleReminder: AppointmentReminder = {
      ...
      appointments: [
        { claimant_name: "John Doe", expert_type: "Orthopedic Surgeon", appointment_date: "Jan 15, 2025", appointment_time: "09:00 AM" },
        { claimant_name: "Jane Smith", expert_type: "Neurologist", appointment_date: "Jan 15, 2025", appointment_time: "11:30 AM" },
        { claimant_name: "Robert Johnson", expert_type: "Clinical Psychologist", appointment_date: "Jan 15, 2025", appointment_time: "02:00 PM" },
        { claimant_name: "Sarah Williams", expert_type: "Occupational Therapist", appointment_date: "Jan 15, 2025", appointment_time: "03:30 PM" },
      ]
    };
