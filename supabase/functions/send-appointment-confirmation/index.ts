  ...
  try {
    ...
    const expertEmailHtml = `
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px; font-size: 11px; color: #374151;">
        ...
        ${expertAccessCode ? `
        <div style="margin-top: 20px; padding: 16px 20px; background-color: #ecfdf5; border: 2px solid #10b981; border-radius: 8px; text-align: center;">
          ...
          <p style="color: #065f46; margin: 8px 0 5px 0; font-size: 11px;">Or click the link below to access your cases directly:</p>
          <a href="${expertAccessLink}" style="display: inline-block; padding: 10px 24px; background: linear-gradient(135deg, #1fb6ce, #159baf); color: #ffffff; text-decoration: none; border-radius: 6px; font-size: 12px; font-weight: bold;">View My Cases</a>
        ...
        <div style="margin-top: 20px; padding: 16px 20px; background-color: #f0f9ff; border: 1px solid #bae6fd; border-radius: 8px; text-align: center;">
          ...
          <a href="https://kamedico-legal.co.za/expert-portal" style="display: inline-block; padding: 8px 24px; background: linear-gradient(135deg, #1fb6ce, #159baf); color: #ffffff; text-decoration: none; border-radius: 6px; font-size: 12px; font-weight: bold;">Access Expert Portal</a>
        </div>
        `}
