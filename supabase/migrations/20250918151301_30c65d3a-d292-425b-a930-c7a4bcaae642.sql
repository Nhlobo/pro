-- Fix the get_medical_experts_secure function by removing the blocking audit log
-- The audit logging was causing read-only transaction errors
...
-- Fix the get_medical_expert_display_safe function as well
