-- Update RLS policies for medical_experts table to allow admin and employee access

-- Drop existing restrictive policies
DROP POLICY IF EXISTS "Block non-admin direct access" ON public.medical_experts;
DROP POLICY IF EXISTS "Admin only access to medical experts" ON public.medical_experts;
DROP POLICY IF EXISTS "Admin full access to medical experts" ON public.medical_experts;

-- Create new policies for admin and employee access
CREATE POLICY "Admin and employee full access to medical experts"
...
-- Update the get_medical_experts_secure function to provide full access to admins and employees
...
-- Update the single expert display function as well
